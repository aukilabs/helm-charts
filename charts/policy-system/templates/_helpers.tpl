...
helm.sh/chart: {{ include "policy-system.chart" . }}
...
*/}}
{{- define "policy-system.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "policy-system.fullname" .) .Values.serviceAccount.name }}
{{- else }}
